...
const HowItWorks = () => {
    return (
        <section className="py-16 px-6 max-w-screen-xl mx-auto text-center mt-24">
            <h2 className="text-3xl font-bold mb-4 text-black">How DataDive Works</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    ...
                    <h3 className="text-xl font-semibold mb-2 text-black">1. Choose a Question Type</h3>
                ...
                <div>
                    ...
                    <h3 className="text-xl font-semibold mb-2 text-black">2. Practice & Answer</h3>
                ...
                <div>
                    ...
                    <h3 className="text-xl font-semibold mb-2 text-black">3. Get AI Feedback</h3>
